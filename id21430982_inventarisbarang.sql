...
--
-- Host: localhost:3306
-- Generation Time: Oct 26, 2023 at 04:48 AM
...
--
-- Database: `id21430982_inventarisbarang`
--
...
(1, 1, 'Meja', 'Micke', 'http://localhost/invetarisbarang/uploads/files/5ha2jd1tq7mwxkf.jpg', '1', '1200000', 1, 1, 'Beli', '2021'),
(2, 0, 'wifi 1', 'Samsung', 'http://localhost/invetarisbarangori/uploads/files/d4hp20ztik1qo8a.png', '1', '2000000', 1, 2, 'beli', '2023'),
(3, 0, 'Laptop 1', 'Sony', '', '1', '2000000', 2, 3, 'beli', '2022'),
(4, 0, 'Laptop 2', 'Samsung', '', '1', '12000000', 1, 2, 'beli', '2020'),
(6, NULL, 'Laptop 3', 'Lenovo', NULL, '1', '15000000', 2, 2, 'Beli', '2023'),
(7, NULL, 'Laptop', 'Apple', NULL, '4', '30000000', 1, 3, 'Dana perusahaan', '2023'),
(8, NULL, 'Laptop', 'Hp', NULL, '4', '7.000.000', 3, 1, 'Dana Perusahaan ', '2023');
...
(1, 'admin', '$2y$10$Wvu.cV.LcuwVylhaRSjuZ.DqwmBgOfEZ2Ng3qbtsppQ8UXJHstkZ2', 'Administrator', 'Administrator@gmail.com', '', NULL, NULL, '2023-05-19 13:01:19', '840b712e0e6a39bf5d4e366aa9bb72fd', 1),
...
(3, 'user1', '$2y$10$LzT/dE8npufFeFPrWgDpI.jfucoYIj8GSOFCG9a9XOaETE8Ax2Wje', 'evi dianasari', 'evi@gmail.com', '', NULL, NULL, '2021-10-11 00:00:00', NULL, 2),
(4, 'cheri', '$2y$10$TXfUEjFMeICvAWZn86UKkO16104pVOAuHet8RK3t8R6z1BEwsz0Fy', 'cheri', 'cheri@gmail.com', NULL, NULL, NULL, '2021-10-11 00:00:00', NULL, 2);
...
--
ALTER TABLE `kondisi`
  MODIFY `Id_Kondisi` int(15) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
