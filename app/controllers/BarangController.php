...
class BarangController extends SecureController{
	...
	function add($formdata = null){
		if($formdata){
			...
			$request = $this->request;
			//fillable fields
			$fields = $this->fields = array("Nama_Barang","Merek","Jumlah_Aset","Nilai_Per_Aset","Id_Ruangan","Id_Kondisi","Asal_Perolehan","Tahun_Perolehan");
	...
	function edit($rec_id = null, $formdata = null){
		...
		$tablename = $this->tablename;
		 //editable fields
		$fields = $this->fields = array("Id_Barang","Nama_Barang","Merek","Jumlah_Aset","Nilai_Per_Aset","Id_Ruangan","Id_Kondisi","Asal_Perolehan","Tahun_Perolehan");
		if($formdata){
			$postdata = $this->format_request_data($formdata);
			$this->rules_array = array(
				'Nama_Barang' => 'required',
