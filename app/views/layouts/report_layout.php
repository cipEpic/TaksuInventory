		...
		<table class="table table-sm">
			<tr>
				...
				<th align="left" valign="middle">
					...
					<small class="sub-title">Efficient inventory management App</small>
				</th>
				<th align="right" valign="middle">
					<div class="company-info">
						<div>Phone: <span class="sub-title">+0361XXXXX</span></div>
						<div>Email: <span class="sub-title">Email@<?php echo SITE_NAME ?></span></div>
