<div id="topbar" class="navbar navbar-expand-md fixed-top navbar-dark" style="background-color: #0A3622;">
    <div class="container-fluid">
        <a class="navbar-brand" href="<?php print_link(HOME_PAGE) ?>">
            ...
            <button type="button" id="sidebarCollapse" class="btn" style="background-color: #0A3622;">
    ...
    if(user_login_status() == true ){ 
    ?>
    <nav id="sidebar" class="navbar-dark" style="background-color: #0A3622;">
